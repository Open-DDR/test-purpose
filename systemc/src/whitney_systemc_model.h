#ifndef WHITNEY_SYSTEMC_MODEL_H
#define WHITNEY_SYSTEMC_MODEL_H
...
// SystemC model for Whitney LPDDR5 Memory Controller
SC_MODULE(WhitneySystemCModel) {
    // Clock and Reset
    sc_in<bool> mck;
    sc_in<bool> mc_rst_b;
    sc_in<bool> porst_b;
        ...
        page_table_row_memory(PAGE_TABLE_DEPTH, 0)
    {
        ...
        ddr_config_reg = 0x00030000; // LPDDR5, 32-bit data width, BL32
        ...
        // Set timing registers (example values for LPDDR5)
